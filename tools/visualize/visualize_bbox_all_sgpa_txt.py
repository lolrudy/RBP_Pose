...
# pred_results_sgpa = mmcv.load('/data/zrd/datasets/NOCS/rseseesults/sgpa_results/REAL275_results.pkl')
...
save_txt_dir = '/data/zrd/RBP_result/96'
    ...
    try:
        ...
        for j in range(len(pred_result['gt_class_ids'])):
            ...
            if pred_scale is not None:
                ...
                np.savetxt(save_txt_path + f'_sgpa_rt_{j}.txt', pred_RT)
                np.savetxt(save_txt_path + f'_sgpa_scale_{j}.txt', pred_scale)
