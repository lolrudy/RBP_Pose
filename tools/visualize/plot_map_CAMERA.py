...
if __name__ == '__main__':
    bottle_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_all_1102_l1/eval_result_model_239/pred_result.pkl'
    bowl_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_all_1102_l1/eval_result_model_239/pred_result.pkl'
    camera_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_camera_1102_l1/eval_result_model_149/pred_result.pkl'
    can_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_all_1102_l1/eval_result_model_239/pred_result.pkl'
    laptop_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_laptop_eval/eval_result_model_49/pred_result.pkl'
    mug_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_all_1102_l1/eval_result_model_239/pred_result.pkl'
    all_path = '/data2/zrd/GPV_pose_all/output/modelsave_CAMERA_all_1102_l1/eval_result_model_239/pred_result.pkl'
    # laptop_path = camera_path = all_path
    dualposenet_path = '/data2/zrd/GPV_pose_result/dualposenet_results/CAMERA25_results.pkl'

    output_path = '/data2/zrd/GPV_pose_result/1120_CAMERA_plot_one_pred'
    ...
    if os.path.exists(output_eval_file_path) and False:
        ...
        for cls_idx in range(1, num_classes+1):
            ...
            for result in pred_results:
                pred_results_dict[result['image_path']] = result
            pred_results = list(pred_results_dict.values())
            for result in pred_results:
            ...
            mmcv.dump(pred_results, os.path.join(output_path, f'{cate}_pred_result.pkl'))
        pred_results_total = list(pred_results_total_dict.values())
        pred_results_all = mmcv.load(all_path)
        pred_results_all_dict = {}
        for result in pred_results_all:
            pred_results_all_dict[result['image_path']] = result
        print(len(pred_results_total))
        print(len(pred_results_total_dict.keys()))

        print(len(pred_results_all))
        print(len(pred_results_all_dict.keys()))
        for key in pred_results_all_dict.keys():
            if key not in pred_results_total_dict.keys():
                pred_results_total.append(pred_results_all_dict[key])
    ...
    output_dpn_eval_file_path = '/data2/zrd/GPV_pose_result/dualposenet_results/CAMERA25_eval_results.pkl'
