...
pred_results_total = mmcv.load('/data2/zrd/GPV_pose_result/1120_CAMERA_plot_update/all_pred_result.pkl')
pred_results_dualposenet = mmcv.load('/data2/zrd/GPV_pose_result/dualposenet_results/CAMERA25_results_dict.pkl')

cam_K = camera_intrinsics = np.array([[577.5, 0, 319.5], [0, 577.5, 239.5], [0, 0, 1]],
...
pred_results_dualposenet_dict = pred_results_dualposenet
...
save_dir = '/data2/zrd/GPV_pose_result/visualize_bbox_all_separate_CAMERA'
detection_dir = '/data2/zrd/datasets/NOCS/detection_dualposenet/data/segmentation_results/CAMERA25/results_val_'
...
for img_path in tqdm(pred_results_total_dict.keys()):
    ...
    real_img_path = os.path.join(dataset_dir, 'CAMERA', img_path[12:])
