...
pred_results_total = mmcv.load('/data/zrd/project/GPV_pose_shape_prior/output/recon_all_shift_nouncertainty/eval_result_model_149/pred_result.pkl')
pred_results_dualposenet = mmcv.load('/data2/zrd/project/GPV_pose_result/dualposenet_results/REAL275_results.pkl')
pred_results_origin = mmcv.load('/data2/zrd/project/GPV_pose_result/dualposenet_results/REAL275_results.pkl')
...
save_dir = '/data2/zrd/GPV_pose_result/visualize_bbox_new_all_separate'
