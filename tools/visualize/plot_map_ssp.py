...
if __name__ == '__main__':
    ...
    bottle_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'
    bowl_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'
    camera_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'
    can_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'
    laptop_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'
    mug_path = 'output/prior_all/eval_result_model_149/pred_result.pkl'

    dualposenet_path = '/data/zrd/RBP_result/dualposenet_results/REAL275_results.pkl'

    output_path = '/data/zrd/RBP_result/0220_ssp'
